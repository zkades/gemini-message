...
const SpamView: React.FC<Props> = ({ conversations, onBack, onSelect }) => {
  return (
    <div className="absolute inset-0 bg-[#0b141b] z-40 flex flex-col animate-fade-in text-white">
      <div className="flex items-center px-4 pt-10 pb-4">
        ...
        <h2 className="text-[20px] font-normal ml-3">Spam & blocked</h2>
      </div>
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar">
        {conversations.length === 0 ? (
          <div className="flex flex-col items-center justify-center mt-32 px-10 text-center opacity-50">
             ...
             <p className="text-[16px]">Spam and blocked messages will appear here</p>
          </div>
        ) : (
            ...
            >
              ...
              <div className="ml-4 flex-1 min-w-0">
                <div className="flex justify-between items-start">
                  ...
                  <span className="text-[12px] text-[#e53935] ml-2">Spam</span>
                </div>
